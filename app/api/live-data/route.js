...
const STOCK_UNIVERSE = [
  ...
  // Biotech & Healthcare
  'BIIB', 'GILD', 'AMGN', 'REGN', 'VRTX', 'ILMN', 'MRNA', 'BNTX', 'JNJ', 'PFE',
  'BMY', 'LLY', 'UNH', 'ANTM', 'CI', 'CVS', 'HUM', 'CNC', 'WBA', 'CVS',
  ...
  'NOC', 'GD', 'F', 'GM', 'TSLA', 'RIVN', 'LCID', 'NIO', 'XPEV', 'LI',
  ...
  // Cloud & Software
  'CRM', 'NOW', 'WDAY', 'ADBE', 'ORCL', 'SAP', 'INTU', 'MSFT', 'GOOGL', 'AMZN',
  'SNOW', 'PLTR', 'ZM', 'DOCU', 'ROKU', 'SHOP', 'SQ', 'PYPL', 'UBER', 'LYFT',
  
  // Meme & High Beta
  'GME', 'AMC', 'BBBY', 'MULN', 'ATER', 'SPRT', 'IRNT', 'PROG', 'RDBX', 'REDX',
  'DWAC', 'PHUN', 'MARK', 'GREE', 'BKKT', 'LCID', 'RIVN', 'HOOD', 'SOFI', 'UPST',
  ...
  'BABA', 'TSM', 'ASML', 'SAP', 'TM', 'NVS', 'NESN', 'ROCHE', 'AZN', 'BP',
  'RDS.A', 'RIO', 'BHP', 'Vale', 'PBR', 'ITUB', 'BBD', 'SAN', 'ING', 'UBS',
  
  // Crypto & Fintech
  'COIN', 'MSTR', 'SQ', 'PYPL', 'SOFI', 'AFRM', 'UPST', 'LC', 'NU', 'OPEN',
  'HOOD', 'WEBR', 'LMND', 'ROOT', 'MTTR', 'PTON', 'ZG', 'ZILLOW', 'REDFIN', 'COMPASS'
];
